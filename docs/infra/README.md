...
| **Cloudflare Pages** | Screencraft（Web フロントエンド） |
| **Cloudflare Workers** | Screencraft（API） |
| **Cloudflare R2** | Screencraft（書き出し画像ストレージ） |
| **AWS Lambda** | KEIBA-YARAZU |
| **AWS DynamoDB** | KEIBA-YARAZU |
| **AWS S3** | KEIBA-YARAZU |
| **AWS EventBridge** | KEIBA-YARAZU |
...
| **Resend** | Screencraft |
| **Sentry** | Screencraft / Memoria |
| **PostHog** | Screencraft |
| **VS Code Remote Tunnels** | 全プロジェクト（リモート開発） |
